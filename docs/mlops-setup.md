...
[ML Config](../my-mlops-project/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts my-mlops-project/terraform/README.md
...
We recommend including all files outside of `my-mlops-project/terraform` in this PR:
...
Follow the instructions in [my-mlops-project/terraform/README.md](../my-mlops-project/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../my-mlops-project/terraform/README.md) to propose, test, and deploy

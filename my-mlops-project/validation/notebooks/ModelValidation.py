...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``my-mlops-project/terraform``
#
#
# Parameters:
#
...
dbutils.widgets.text(
    "experiment_name",
    "/my-mlops-project/my-mlops-project-experiment-test",
    "Experiment Name",
)

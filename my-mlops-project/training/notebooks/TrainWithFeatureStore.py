...
# It is configured and can be executed as a training-job.tf job defined under ``my-mlops-project/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"//my-mlops-project-{env}/my-mlops-project-experiment-test",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "my-mlops-project-model-test", label="Model Name"
)
